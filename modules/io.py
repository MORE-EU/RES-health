...
def initilization_of_population_mp(pop_size,events):
    """
    Initialize a population of individuals with random attributes for a matrix profile algorithm.
    
    Args:
        pop_size (int): The size of the population.
        events (int): The number of events or segments.

    Returns:
        np.ndarray: A numpy array containing the initialized population.
    """
...
def crossover(parents, offspring_size):
    """
    Perform crossover operation to create offspring from parent individuals.
    
    Args:
        parents (numpy.ndarray): The parent individuals to mate.
        offspring_size (tuple): The size of the offspring (number of offspring, number of genes per offspring).
        
    Returns:
        numpy.ndarray: Offspring resulting from the crossover operation.
    """
...
def mutation(offspring_crossover, num_mutations):
     """
    Apply mutation to the offspring by randomly changing a certain number of genes in each individual.
    
    Args:
        offspring_crossover (numpy.ndarray): Offspring individuals to mutate.
        num_mutations (int): Number of mutations to apply to each individual.
        
    Returns:
        numpy.ndarray: Offspring after mutation.
    """
